...
description: "Digging into the Node.js thread pool, libuv, and why async methods let Node parallelize work for you."
---

![NodeJS](/assets/img/nodejs-wall.jpeg)
...
![crypto-sync-4](/assets/img/crypto-sync-4.png)
...
![crypto-async-4](/assets/img/crypto-async-4.png)
...
![crypto-async-6](/assets/img/crypto-async-6.png)
